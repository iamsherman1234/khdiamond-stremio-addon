...
UPLOAD_PAGE = page("KhDiamond Setup", """
  ...
  <p>Provide your khdiamond.net cookies to create your personal Stremio addon.</p>
  
  <div class="tabs">
    <div class="tab active" onclick="switchTab(0)">📋 Paste Cookies</div>
    <div class="tab" onclick="switchTab(1)">📁 Upload File</div>
  </div>
  ...
  <div id="tab1" style="display:none">
    <form action="/upload" method="post" enctype="multipart/form-data">
      ...
      <div class="upload-area" onclick="document.getElementById('file').click()">
        <p>📁 Click to select <strong>cookies.txt</strong></p>
      </div>
      <input type="file" id="file" name="cookies" accept=".txt">
      <button type="submit" class="btn">Get My Addon URL</button>
    </form>
  </div>
...
async def upload(
    ...
    if method == "paste" and cookies_text and cookies_text.strip():
        ...
        return HTMLResponse(page("Error", "<h1>No Cookies Provided</h1><a href='/'><button class='btn btn-secondary'>Try Again</button></a>"))
